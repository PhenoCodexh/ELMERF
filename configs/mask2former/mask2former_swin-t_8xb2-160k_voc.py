...
# optimizer
embed_multi = dict(lr_mult=1.0, decay_mult=0.1)
optimizer = dict(
...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=30000, val_interval=600)
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type='CheckpointHook', by_epoch=False, interval=600,
        save_best='mIoU'),
...
embed_multi = dict(lr_mult=2.0, decay_mult=0.0)
custom_keys = {
    'backbone': dict(lr_mult=0.2, decay_mult=2.0),
